<?php
    if (file_exists('../config/settings.php')) {
        die("Already Installed. Please remove /config/settings.php to reinstall");
    }
            ...
            <div id="wizard">
                <h3>
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <div class="bd-wizard-step-subtitle">Thank you for purchasing.</div>
                        </div>
                    </div>
                </h3>
                <section>
                    <div class="content-wrapper">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="" style="">
                                    <img style="width:100%" src="<?php echo $site_url; ?>installer/img/undraw_Lighthouse_frb8.svg" />
                                </div>
                ...
                <h3>
                    <div class="media">
                        ...
                        <div class="media-body">
                            <div class="bd-wizard-step-title">Database Configuration</div>
